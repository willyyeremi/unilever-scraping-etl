...
def run_pipeline(connection_engine):
    ...
    last_valid_page = find_last_valid_page("https://www.blibli.com/brand/unilever-official-store?promoTab=false&excludeProductList=false&page=1&start=0&sort=7")
    collect_active_product_links_parallel_executor("https://www.blibli.com/brand/unilever-official-store?promoTab=false&excludeProductList=false&page=1&start=0&sort=7", last_valid_page, engine, num_processes = 5)
